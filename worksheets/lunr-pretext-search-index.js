...
},
{
  ...
  "type": "Worksheet",
  "number": "",
  "title": "Fake Worksheet: Simplfying Square Roots",
  "body": " Fake Worksheet: Simplfying Square Roots   This activity covers simplyfing square roots in preparation for using the quadratic formula later in the semester.     Plot points in the Cartesian Plane.  Simplify square roots.    When using square roots, we often want to provide exact answers. This will require that we simplify square roots. We will not use decimal approximations unless specifically instructed to do so.  Look for perfect square factors of the number under the radical.  Include one worked out example here.     Together: Simplify each of the following square roots, if possible.                    Your Turn:        Test Yourself     "
},
{
  "id": "fake-wkst-3",
  "level": "2",
  "url": "fake-wkst.html#fake-wkst-3",
  "type": "Objectives",
  "number": "",
  "title": "",
  "body": "  Plot points in the Cartesian Plane.  Simplify square roots.   "
},
{
  "id": "fake-wkst-6",
  "level": "2",
  "url": "fake-wkst.html#fake-wkst-6",
  "type": "Example",
  "number": "3",
  "title": "",
  "body": "Include one worked out example here. "
},
{
  "id": "fake-wkst-7-1",
  "level": "2",
  "url": "fake-wkst.html#fake-wkst-7-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Together: Simplify each of the following square roots, if possible.                 "
},
{
  "id": "fake-wkst-7-2",
  "level": "2",
  "url": "fake-wkst.html#fake-wkst-7-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "  Your Turn:   "
},
{
  "id": "fake-wkst-8-1",
  "level": "2",
  "url": "fake-wkst.html#fake-wkst-8-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
  "body": "  Test Yourself   "
